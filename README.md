...
This is an implementation of the CMU Pronouncing Dictionary in the YAML format.
It was created to provide ease of use for software that supports YAML dictionaries.
